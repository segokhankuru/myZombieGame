...
**Stage:** preproduction
**Milestone:** **M-01 Solo Çekirdek Döngü** — 12 işten 2'si kapandı, 3'ü oyun testi bekliyor
**Review mode:** lean
...
**Sürüyor:** M1-03 gri kutu harita (ölçü ayarı) · M1-04 zombi · M1-05 doğum, havuzlama
ve tur akışı — hepsinin kodu ve kurulumu bitti, **kalan tek şey oynayıp hissiyata bakmak**
**Sıradaki:** M1-06 silah (bu milestone'un en kritik işi)
...
**Toplam 114 EditMode testi yeşil.** Derleme ve testler Unity açmadan koşuyor:
